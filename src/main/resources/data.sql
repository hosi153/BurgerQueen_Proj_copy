...
insert into "CART" (CART_ID,MEMBER_ID, TOTAL_COUNT, total_price) values (1,1,1, 2000);
insert into "CART" (CART_ID,MEMBER_ID, TOTAL_COUNT, total_price) values (2,2,1, 2000);
